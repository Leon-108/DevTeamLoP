...
switch _mode do {
	...
	case "saveSettings": {
		...
		[(getText(missionConfigFile >> "maverick_navigation_cfg" >> "localization" >> "msgSettingsSaved")),"GREEN",5] spawn life_fnc_notification_system;
	};
	...
	case "reset": {
		...
		saveProfileNamespace;
		[(getText(missionConfigFile >> "maverick_navigation_cfg" >> "localization" >> "msgPositionReset")),"GREEN",5] spawn life_fnc_notification_system;
	};
