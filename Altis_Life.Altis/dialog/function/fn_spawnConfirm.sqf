...
if(count life_spawn_point isEqualto 0) then
{
	...
	//t/itleText[format["%2 %1",_sp select 1,localize "STR_Spawn_Spawned"],"BLACK IN"];
	...
	else
{
	...
	//t/itleText[format["%2 %1",life_spawn_point select 1,localize "STR_Spawn_Spawned"],"BLACK IN"];
