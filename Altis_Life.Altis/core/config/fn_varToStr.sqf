...
switch (_var) do
{
	...
	case "life_inv_water": {"Eistee"}; // edit...
//	case "life_inv_bier": {"Bier"};
//	case "life_inv_doner": {"Boulette"}; // edit...
	case "life_inv_bier": {"Bier"};
	case "life_inv_doner": {"Pizza"}; // edit...
	case "life_inv_coffee": {"Kaffee"}; // edit...
	case "life_inv_turtlesoup": {"Schildkrötensuppe"};
	case "life_inv_donuts": {"Donut"}; // edit...
	...
	case "life_inv_ironore": {"Holz"};
	case "life_inv_ironr": {"Papier"};
	...
	case "life_inv_radioaktivp": {"Brennelemente"};
	...
	case "life_inv_brennstabu": {"Feuchter Tabak"};
	case "life_inv_brennstabp": {"Trockener Tabak"};
	case "life_inv_atomwaffe": {"Illegale Zigaretten"};
	case "life_inv_spikeStrip": {"Nagelbrett"};
	case "life_inv_rock": {"Kautschuk"};
	case "life_inv_cement": {"Reifen"};
	...
	case "life_inv_awasteu": {"Brennstab"};
	case "life_inv_awastep": {"Atommüll"};
	...
	case "license_cop_swatazubi": {"swatazubi Lizenz"};
	case "license_cop_cg": {"Küstenwache"};
	case "license_civ_rebel": {"Banditen Lizenz"};
	case "license_civ_rebel2": {"Rebellen Lizenz"};
	...
	case "license_civ_papier": {"Papier Lizenz"};
	...
	case "license_civ_kautschuk": {"Kautschuk / Reifen Lizenz"};
	case "license_civ_tabak": {"Tabak Lizenz"};
	case "license_civ_bhc": {"BHC Lizenz"};
	case "license_civ_itabak": {"Zigaretten Lizenz"};
	case "license_civ_admin1": {"Admin Lizenz"};
	case "license_civ_donator1": {"VIP Lizenz"};
	case "license_civ_dm": {"Dithmarscher Lizenz"};
	case "license_civ_evers": {"Evers Lizenz"};
	case "license_civ_leer": {"Winchester Lizenz"};
	case "license_civ_pa": {"PA Lizenz"};
	case "license_civ_ssg": {"SSG Lizenz"};
	case "license_civ_tgh": {"TGH Lizenz"};
	...
	case "license_civ_tazer": {"Geheim Lizenz"};
	case "license_civ_rebacess": {"Rebellen Zugangskarte"};
	case "license_civ_atom": {"Atommüllentsorgung"};
};
