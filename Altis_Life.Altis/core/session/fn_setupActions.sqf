...
switch (playerSide) do
{
	...
	case independent:
	{
		...
		//CopEnter - Exit
		life_actions = life_actions + [player addAction[localize "STR_pAct_GoOut",life_fnc_copmedicEnter,"exit",100,false,false,"",'(vehicle player != player) && (locked(vehicle player)==2)']];
		//Ausweis
		life_actions = life_actions + [player addAction["<t color='#FFFF00'>Ausweis zeigen</t>",life_fnc_Lizenzzeigen,"",1,false,true,"",'!isNull cursorTarget && cursorTarget isKindOf "Man"']];
		//Rechnung
		life_actions = life_actions + [player addAction["<t color='#FFFF00'>Rechnung stellen</t>",life_fnc_Rechnungschreiben,"",1,false,true,"",'!isNull cursorTarget && cursorTarget isKindOf "Man"']];
