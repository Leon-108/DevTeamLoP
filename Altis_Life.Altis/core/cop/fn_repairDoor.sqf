...
*/
private["_building","_doors","_door","_cP","_cpRate","_ui","_title","_titleTxt"];
_building = [_this,0,ObjNull,[ObjNull]] call BIS_fnc_param;
if(isNull _building) exitWith {};
if(!(_building isKindOf "House_F")) exitWith {
	//h/int "You are not looking at a house door."
	["You are not looking at a house door.","RED",10] spawn life_fnc_notification_system;
};
_doors = 1;
...
if(life_interrupted) exitWith {
	...
	[localize "STR_NOTF_ActionCancel","GREEN",5] spawn life_fnc_notification_system;
