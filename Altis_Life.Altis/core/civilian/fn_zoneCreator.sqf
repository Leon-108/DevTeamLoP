...
_zone setTriggerArea[50,50,0,false];
_zone setTriggerActivation["CIV","PRESENT",true];
_zone setTriggerStatements["player in thislist","LIFE_Action_brennstab = player addAction['Sammle Tabak',life_fnc_gatherUran,'',0,false,false,'','!life_action_gather'];","player removeAction LIFE_Action_brennstab;"];
} foreach _uranZones;
