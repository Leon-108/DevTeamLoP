...
if !(isNull objectParent player) exitWith {[localize "STR_NOTF_ActionInVehicle","YELLOW",5] spawn life_fnc_notification_system;};
...
if !(_exit) exitWith {[localize "STR_Shop_Veh_NoLicense","RED",5] spawn life_fnc_notification_system;};
