...
if (!isClass(missionConfigFile >> "VirtualShops" >> life_shop_type)) exitWith {closeDialog 0; [localize "STR_NOTF_ConfigDoesNotExist","RED",10] spawn life_fnc_notification_system;}; //Make sure the entry exists..
