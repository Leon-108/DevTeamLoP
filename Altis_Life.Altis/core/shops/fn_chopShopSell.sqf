...
_price = 1000;//_control lbValue (lbCurSel _control);
...
//h/int localize "STR_Shop_ChopShopSelling";
[localize "STR_Shop_ChopShopSelling","YELLOW",5] spawn life_fnc_notification_system;
