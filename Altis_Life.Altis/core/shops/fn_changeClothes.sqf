...
if(_selection isEqualto -1) exitWith {[localize "STR_Shop_NoSelection","RED",10] spawn life_fnc_notification_system;};
if(isNull _control) exitWith {[localize "STR_Shop_NoDisplay","RED",10] spawn life_fnc_notification_system;};
