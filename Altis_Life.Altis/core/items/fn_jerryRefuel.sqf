...
if(isNull _vehicle) exitWith {
	//h/int localize "STR_ISTR_Jerry_NotLooking"
	[localize "STR_ISTR_Jerry_NotLooking","RED",10] spawn life_fnc_notification_system;
};
if(!(_vehicle isKindOF "LandVehicle") && !(_vehicle isKindOf "Air") && !(_vehicle isKindOf "Ship")) exitWith {};
if(player distance _vehicle > 7.5) exitWith {
	//h/int localize "STR_ISTR_Jerry_NotNear"
	[localize "STR_ISTR_Jerry_NotNear","RED",10] spawn life_fnc_notification_system;
};
...
//t/itleText[format[localize "STR_ISTR_Jerry_Success",_displayName],"PLAIN"];
[format[localize "STR_ISTR_Jerry_Success",_displayName],"GREEN",5] spawn life_fnc_notification_system;
