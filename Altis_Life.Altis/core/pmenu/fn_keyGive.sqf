...
_pindex = [_pid,_owners] call TON_fnc_index;
if !(_pindex  isEqualto  -1) then {
...
[format["You have given %1 keys to your %2",_unit getVariable["realname",name _unit],_name],"PINK",5] spawn life_fnc_notification_system;
