...
then {
//h/int "Im gefesselten Zustand kannst du das Handy nicht benutzen!";
["Im gefesselten Zustand kannst du das Handy nicht benutzen!","RED",10] spawn life_fnc_notification_system;
closeDialog 0;
sleep 1;
closeDialog 0;
}
