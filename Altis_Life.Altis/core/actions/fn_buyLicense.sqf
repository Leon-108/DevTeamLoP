...
if (CASH < _price) exitWith {[format[localize "STR_NOTF_NE_1",[_price] call life_fnc_numberText,localize _displayName],"RED",10] spawn life_fnc_notification_system;};
CASH = CASH - _price;
[0] call SOCK_fnc_updatePartial;
[format[localize "STR_NOTF_B_1", localize _displayName,[_price] call life_fnc_numberText],"GREEN",5] spawn life_fnc_notification_system;
