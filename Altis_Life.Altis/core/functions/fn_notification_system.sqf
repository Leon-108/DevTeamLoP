...
private _headerColor = [0,0,0];
if(_color isEqualTo "RED") then {_headerColor = [255,0,0,0.5];}; 
if(_color isEqualTo "GREEN") then {_headerColor = [0,255,0,0.5];}; 
if(_color isEqualTo "BLUE") then {_headerColor = [0,0,255,0.5];}; 
if(_color isEqualTo "WHITE") then {_headerColor = [255,255,255,0.5];}; 
if(_color isEqualTo "BLACK") then {_headerColor = [0,0,0,0.5];}; 
if(_color isEqualTo "YELLOW") then {_headerColor = [255,255,0,0.5];}; 
if(_color isEqualTo "PINK") then {_headerColor = [255,0,255,0.5];}; 
if(_color isEqualTo "CYAN") then {_headerColor = [0,255,255,0.5];};
if(_color isEqualTo "PURPLE") then {_headerColor = [130,0,255,0.5];};
