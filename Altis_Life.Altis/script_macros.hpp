...
#define CASH life_8cash
#define BANK life_atm9cash
...
#define ITEM_LIQUID(varName) M_CONFIG(getNumber,"VirtualItems",varName,"liquid")
...
#define ITEM_SHOWPRICE(varName) M_CONFIG(getNumber,"VirtualItems",varName,"showPrice")
